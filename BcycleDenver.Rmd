...
yday_merge <- merge(bcyc_daily,wea) %>% select(yday,n,mean_temp,duration)
yday_merge %>% ggplot(aes(mean_temp,n)) + geom_point() +  geom_smooth(col='red') + geom_smooth(method = "lm")
```
